...
public class TiendaLibros implements MetodosInterf{
    ...
    public TiendaLibros(String cliente, int numeroSorteo) {
    ...
    public void inscribirDatos(){
        ...
        System.out.println(cliente + " se ha inscrito en el sorteo de Tienda de Libros.");
    ...
    public void comunicarResultado(){
        ...
        System.out.println("El numero obtenido para " + cliente + " en la Tienda de Libros es el: " + numeroSorteo);
